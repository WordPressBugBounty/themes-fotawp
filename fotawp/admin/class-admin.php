...
class FotaWP_Admin
{
	...
	public function enqueue_admin_assets()
	{
		...
		$fotawp_current_screen = get_current_screen();
		...
		if ((isset($_GET['page']) && ! empty($_GET['page']) && 'about-fotawp' === $_GET['page']) || in_array($fotawp_current_screen->id, $allowed_pages, true)) {
	...
	public function welcome_notice()
	{
		...
		if (! in_array($current_screen->id, $allowed_screens, true) || is_network_admin() || ! current_user_can('manage_options') || get_option('fotawp_dismissed_custom_notice')) {
			return;
		}
?>
			...
			<div class="content-holder">
				<div class="notices">
					<figure class="brand-logo">
						<img width="44" height="44" src="<?php echo esc_url(self::$url . 'images/fotawp.png'); ?>" alt="Cozy Blocks logo" />
					</figure>

					<div>
						<h2 class="notice-heading"><?php esc_html_e('Welcome to FotaWP! Build Your Professional Website with Ease  🎉', 'fotawp'); ?></h2>

						<p><?php esc_html_e('Install and activate Cozy Blocks to unlock advanced customization, powerful custom blocks, and a library of ready-made templates and patterns—all designed to help you build and customize your website faster and easier.', 'fotawp'); ?></p>
						...
						<div class="notice-buttons">
							...
							?>
								<button class="cozy-addons-install notice-button has-spinner">
									<a href="#"><?php esc_html_e('Install & Activate Cozy Blocks →', 'fotawp'); ?></a>
