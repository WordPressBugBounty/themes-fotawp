...
class FotaWP_Admin_Ajax {
	...
	private function __construct() {
		add_action( 'wp_ajax_fotawp_dismissble_notice', array( $this, 'dismiss_welcome_notice' ) );
		add_action( 'wp_ajax_fotawp_install_and_activate_plugins', array( $this, 'install_activate_plugins' ) );
	}
